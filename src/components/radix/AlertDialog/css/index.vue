...
<template>
  <AlertDialogRoot>
    <AlertDialogTrigger class="Button green"> Delete account </AlertDialogTrigger>
    <AlertDialogPortal>
      <AlertDialogOverlay class="AlertDialogOverlay" />
      <AlertDialogContent class="AlertDialogContent">
        <AlertDialogTitle class="AlertDialogTitle"> Are you absolutely sure? </AlertDialogTitle>
