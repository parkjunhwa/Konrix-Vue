  ...
  <div class="card">
    <div class="p-6">
      <div class="flex justify-between items-start">
        <div>
          <h4 class="text-base mb-1 text-gray-600 dark:text-gray-400">
            {{ title }}
          </h4>
      ...
      <div class="flex items-end">
        <div class="flex-grow">
          <p class="text-[13px] text-gray-400 dark:text-gray-500 font-semibold">
            <i class="mgc_alarm_2_line"></i> {{ time }}
          </p>
        </div>
        <div class="flex">
          <a v-for="(assignee, index) in assignees" :key="index" :class="index != 0 ? '-ms-2' : ''">
            <img
              :src="assignee.img"
