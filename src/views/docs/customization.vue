<template>
  <Layout>
    <Breadcrumb title="Customization" subtitle="Documentation" />
    ...
    <div class="flex flex-col gap-6">
      <div class="card">
        ...
        <div class="p-6">
          <p>
            You can change the colour palette of any demo very easily by simply changing the few
            SCSS variables' value.
          </p>

          <p>
            In order to modify the colors in existing themes, open the
            <code>_theme-config.scss</code> file from
            <code>src/assets/scss/config</code>
            and change any variable in it. Your changes would get reflected automatically in any
            Tailwind based components or elements.
          </p>
        </div>
      </div>
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200">
                    <code class="text-nowrap">data-mode</code>
                  </td>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200">
                    String
                  </td>
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200">
                    Changes overall color scheme to dark
                  </td>
                </tr>
                <tr>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200">
                    <code class="text-nowrap">dir</code>
                  </td>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200">
                    String
                  </td>
                ...
                <tr>
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200">
                    Changes the width of overall layout
                  </td>
                </tr>
                <tr>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200">
      ...
      <div class="card">
        ...
        <div class="p-6">
          <p>
            ...
            <code>views/pages/starter.vue</code>). It allows you to get started easily and helps you
            to add new page. Please note following important points:
          </p>
          <ul>
            <li>
              Most of default/basic form elements along with few advanced elements are separately
              add css and js.
            </li>
            <li>
              Few elements e.g. charts, data tables, calendar, maps etc requires you to include
              corresponding css and js files in your page. Please check corresponding documentation
              page for the same.
            </li>
          </ul>
        </div>
