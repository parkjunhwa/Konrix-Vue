<template>
  <Layout>
    <Breadcrumb title="Lightbox" subtitle="Extended" />
    <div class="grid grid-cols-1 gap-6">
      <CustomSyntax title="Single Image Lightbox">
        <template #card-body>
          <div class="grid lg:grid-cols-4 gap-5">
            <div>
              <a href="/src/assets/images/small/img-1.jpg" class="image-popup">
                <img
            ...
            <div>
              <a href="/src/assets/images/small/img-2.jpg" class="image-popup">
                <img
            ...
            <div>
              <a href="/src/assets/images/small/img-4.jpg" class="image-popup">
                <img
            ...
            <div>
              <a href="/src/assets/images/small/img-5.jpg" class="image-popup">
                <img
      ...
      <CustomSyntax title="Images with Description">
        <template #card-body>
          <div class="grid lg:grid-cols-3 gap-5">
            <div>
              <a
                href="/src/assets/images/small/img-4.jpg"
            ...
            <div>
              <a
                href="/src/assets/images/small/img-5.jpg"
                class="image-popup-desc"
              ...
              <div class="glightbox-desc custom-desc1">
                ...
                <p>
                  ...
                  >
                  ipsum vehicula eros ultrices lacinia Vestibulum ante ipsum primis in faucibus orci
                  luctus et ultrices posuere cubilia Curae Duis quis ipsum vehicula eros ultrices
                  lacinia. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
                </p>
                <p>
                  Primis pharetra facilisis lorem quis penatibus ad nulla inceptos, dui per tempor
                  taciti aliquet consequat sodales, curae tristique gravida auctor interdum
                  malesuada sagittis. Felis pretium eros ligula natoque ad ante rutrum himenaeos,
                  adipiscing urna mauris porta quam efficitur odio, sagittis morbi tellus nisi
            ...
            <div>
              <a
                href="/src/assets/images/small/img-1.jpg"
                class="image-popup-desc"
              ...
              <div class="glightbox-desc custom-desc2">
                <p>
                  You can set the position of the description in different ways for example top,
                  bottom, left or right
                </p>
                <p>
                  Duis quis ipsum vehicula eros ultrices lacinia. Vestibulum ante ipsum primis in
      ...
      <CustomSyntax title="Popup with Video or Map">
        <template #card-body>
          <div class="flex flex-wrap gap-4">
            <!-- Youtube Video -->
            <a
              href="https://www.youtube.com/watch?v=0O2aH4XLbto"
              class="image-popup-video-button rounded-md bg-indigo-600 py-2 px-3 text-sm font-semibold leading-5 text-white hover:bg-indigo-500"
            ...
            <a
              ...
              data-description="Vimeo Video Popup"
            >
              Open Vimeo Video
            </a>
          </div>
      ...
      <CustomSyntax title="Videos Gallery">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            ...
            . You can specify a default width for the videos or set different widths to each video
            in your gallery. The videos are 100% responsive and will play correctly on mobile
            devices.
          </p>
          ...
          <div class="grid lg: grid-cols-3 gap-4">
            ...
            <div>
              <div>
                <a href="/src/assets/images/lightbox-video.mp4" class="image-popup-video">
      ...
      <CustomSyntax title="Iframes and Inline Elements">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            You can easily add iframes by simply entering the url, it could be a web page, a video,
            google maps, etc. also you can display any div of your page by entering the ID in the
            href attribute.
          </p>
