  ...
  <Layout>
    ...
    <div class="flex flex-col gap-6">
        ...
        <template #card-body>
          <div class="grid md:grid-cols-2 gap-5">
            ...
            <div id="example2-right" class="flex flex-col gap-3">
              <div
                class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700 tinted"
              >
                Item 1
              </div>
              <div
      ...
      <CustomSyntax title="Cloning">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            Try dragging from one list to another. The item you drag will be cloned and the clone
            will stay in the original list.
          </p>
          <div class="grid md:grid-cols-2 gap-5">
      ...
      <CustomSyntax title="Disabling Sorting">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            ...
            <code>sort</code> option set to false. However, you can still drag from the list on the
      ...
      <CustomSyntax title="Handle With Icon">
        <template #card-body>
          <div id="example5" class="flex flex-col gap-3">
            <div class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700">
              <i class="mgc_move_line handle"></i>&nbsp;&nbsp;Item 1
            </div>
            <div class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700">
              <i class="mgc_move_line handle"></i>&nbsp;&nbsp;Item 2
            </div>
            <div class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700">
              <i class="mgc_move_line handle"></i>&nbsp;&nbsp;Item 3
            </div>
            <div class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700">
              <i class="mgc_move_line handle"></i>&nbsp;&nbsp;Item 4
            </div>
            <div class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700">
              <i class="mgc_move_line handle"></i>&nbsp;&nbsp;Item 5
            </div>
            <div class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700">
              <i class="mgc_move_line handle"></i>&nbsp;&nbsp;Item 6
            </div>
          </div>
        </template>
      </CustomSyntax>
      ...
      <CustomSyntax title="Filter">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            Try dragging the item with a red background. It cannot be done, because that item is
            filtered out using the <code>filter</code> option.
          </p>
          <div id="example6" class="flex flex-col gap-3">
            ...
            <div
              class="rounded-md border px-6 py-3 bg-danger filtered text-white border-gray-200 dark:border-gray-700"
            >
              Filtered
            </div>
            <div class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700">
      ...
      <CustomSyntax title="Nested Sortables Example">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            NOTE: When using nested Sortables with animation, it is recommended that the
            <code>fallbackOnBody</code> option is set to true. <br />It is also always recommended
            that either the <code>invertSwap</code> option is set to true, or the
            <code>swapThreshold</code> option is lower than the default value of 1 (eg
            <code>0.65</code>).
          </p>
          <div id="nestedDemo" class="flex flex-col gap-3 nested-sortable">
            <div
              class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700 nested-1"
            >
              <div class="pb-3">Item 1.1</div>
              <div class="list-group nested-sortable">
                <div
                  class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700 nested-2"
                >
                  Item 2.1
                </div>
                <div
                ...
                >
                  ...
                  <div class="list-group nested-sortable">
                    <div
                      class="card cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-700 nested-3"
                    >
                      Item 3.1
                    </div>
                    <div
      ...
      <CustomSyntax title="MultiDrag">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            ...
            <a
              target="_blank"
              href="https://github.com/SortableJS/Sortable/tree/master/plugins/MultiDrag"
              >MultiDrag</a
            >
            plugin allows for multiple items to be dragged at a time. You can click to "select"
            multiple items, and then drag them as one item.
          </p>
      ...
      <CustomSyntax title="Swap">
        <template #card-body>
          ...
          <p class="text-gray-400 mb-4">
            ...
            <a
              target="_blank"
              href="https://github.com/SortableJS/Sortable/tree/master/plugins/Swap"
              >Swap</a
            >
            plugin changes the behaviour of Sortable to allow for items to be swapped with eachother
            rather than sorted.
          </p>
