      ...
      <CustomSyntax title="On hover Event">
        <template #card-body>
          <div>
            ...
            <span
              class="ratingnum inline-block text-center rounded-full w-6 h-full text-sm bg-info text-white align-middle ms-2"
            ></span>
          </div>
        </template>
      </CustomSyntax>
      ...
      <CustomSyntax title="Clear/Reset rater">
        <template #card-body>
          <div class="flex items-center">
            ...
            <button id="raterreset-button" class="btn btn-sm bg-primary text-white ms-4">
              Reset
            </button>
          </div>
        </template>
