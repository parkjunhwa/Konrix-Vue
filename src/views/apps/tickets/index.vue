        ...
        <div class="p-5">
          <div class="flex justify-between">
            <div
              ...
              :class="index == 0 ? `bg-${card.color}/25` : `bg-${card.color}-100`"
            >
              <i
                :class="
                  index == 0
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <tr v-for="item in tableData" :key="item.id">
                ...
                <td class="whitespace-nowrap py-4 pe-3 text-sm">
                  <div class="flex items-center">
                    <div class="h-10 w-10 flex-shrink-0">
                      <img class="h-10 w-10 rounded-full" :src="item.image.image" alt="" />
                    </div>
                ...
                <td class="whitespace-nowrap py-4 px-3 text-sm">
                  <img class="h-10 w-10 rounded-full" :src="item.assignee.image" alt="" />
                </td>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                  <div
                    ...
                    :class="item.status == 'Open' ? 'bg-success/90 ' : 'bg-dark/80 '"
                  >
                    {{ item.status }}
                  </div>
                </td>
