      ...
      <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div class="card" v-for="(project, index) in projectList" :key="index">
          <div class="card-header">
            <div class="flex justify-between items-center">
              ...
              <div
                ...
                :class="project.status == 'Pending' ? 'bg-warning/60' : 'bg-success'"
                role="alert"
              >
          ...
          <div class="flex flex-col">
            <div class="py-3 px-6">
              <h5 class="my-2">
                <a href="#" class="text-slate-900 dark:text-slate-200">{{ project.title }}</a>
              </h5>
              ...
              <div class="flex -space-x-2">
                <a href="javascript: void(0);" v-for="(assignee, index) in project.assignees">
                  <img
              ...
              <div class="grid lg:grid-cols-2 gap-4">
                ...
                <div class="flex items-center gap-2">
                  <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                    <div class="h-1.5 rounded-full" :class="project.progressClass"></div>
                  </div>
