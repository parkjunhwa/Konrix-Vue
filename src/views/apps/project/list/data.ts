...
export const projectList = [
  {
    ...
    subtxt: 'If several languages coalesce, the grammar of the resulting language is more regular.',
  ...
  },
  {
    ...
    subtxt: 'To achieve this, it would be necessary to have uniform grammar and more common words.',
    assignees: [assignees[3], assignees[4], assignees[5], assignees[6], assignees[10]],
    date: '28 nov',
    chat: 62,
    comments: 196,
    progress: 33,
  ...
  },
  {
    ...
    subtxt: 'Everyone realizes why a new common language refuse to pay expensive translators.',
  ...
  },
  {
    ...
    subtxt: 'The languages only differ in their grammar pronunciation and their most common words.',
