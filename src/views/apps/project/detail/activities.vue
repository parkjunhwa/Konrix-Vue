  ...
  <div class="card">
    ...
    <div class="table overflow-hidden w-full">
      <div class="divide-y divide-gray-300 dark:divide-gray-700 overflow-auto w-full max-w-full">
        <div class="p-3" v-for="(assignee, index) in projectActivities" :key="index">
          <div class="flex items-center gap-3">
            <div class="h-10 w-10 flex-shrink-0">
              <img class="h-10 w-10 rounded-full" :src="assignee.image" alt="" />
            </div>
            ...
            <div class="px-3 py-1 md:block hidden rounded text-xs font-medium">
              {{ assignee.workingOn }}
            </div>
            <div class="ms-auto">
              <div
                ...
                :class="
                  assignee.status == 'Working'
                    ...
                    : '' || assignee.status == 'Complated'
                      ? 'bg-success/25 text-success'
                      : '' || assignee.status == 'Stop'
...
<script lang="ts">
import { projectActivities } from './data'
