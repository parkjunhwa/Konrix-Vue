        ...
        <div class="p-5">
          <div class="hs-dropdown relative inline-flex m-auto w-full">
            <a
              ...
              type="button"
              class="hs-dropdown-toggle btn inline-flex justify-center items-center bg-primary text-white w-full"
            >
              <i class="mgc_add_line text-lg me-2"></i> Create New
            </a>

            <div
              class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-50 duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2"
            >
              <a
                    ...
                    <div class="h-14 w-14">
                      <span class="flex h-full w-full items-center justify-center">
                        <vue-feather
                          type="folder"
                          fill="warning"
                          class="h-full w-full fill-warning text-warning"
                        ></vue-feather>
                      </span>
                    </div>
                    <div class="space-y-1">
