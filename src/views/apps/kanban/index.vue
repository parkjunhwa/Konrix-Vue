        ...
        <div class="flex overflow-x-auto custom-scroll gap-6 pb-4">
          ...
          >
            ...
            <Draggable
              ...
              id="kanbanborad-one"
            >
              <div class="card p-4 cursor-pointer" v-for="(task, index) in todoTasks" :key="index">
                <div class="flex justify-between items-center">
                  <h4
                    class="flex justify-between items-center h-6 px-3 text-xs font-semibold rounded-full"
                    :class="`text-${task.color} bg-${task.color}/25`"
          ...
          >
            ...
            <Draggable
              ...
              id="kanbanborad-four"
            >
              <div class="card p-4 cursor-pointer" v-for="(task, index) in doneTasks" :key="index">
                <div class="flex justify-between items-center">
                  <h4
                    class="flex justify-between items-center h-6 px-3 text-xs font-semibold rounded-full"
                    :class="`text-${task.color} bg-${task.color}/25`"
          ...
          >
            ...
            <Draggable
              ...
              id="kanbanborad-six"
            >
              <div class="card p-4 cursor-pointer" v-for="(task, index) in newTasks" :key="index">
                <div class="flex justify-between items-center">
                  <h4
                    class="flex justify-between items-center h-6 px-3 text-xs font-semibold rounded-full"
                    :class="`text-${task.color} bg-${task.color}/25`"
