            ...
            <div class="col-span-3">
              <div class="form-check">
                <input
                  ...
                  required
                />
                <label class="ms-1.5" for="invalidCheck2"> Agree to terms and conditions </label>
              </div>
            </div>
            <div class="col-span-3">
      ...
      <CustomSyntax title="PristineJS Validation">
        <template #card-body>
          <p class="text-gray-400 text-sm mb-4">
            Three part must included <code>.form-valid, .form-group and required</code> element.
            More details about Pristine please read
            <a target="_blank" href="https://github.com/sha256/Pristine" class="text-primary"
              >on here</a
            >
          </p>
          <form class="valid-form grid lg:grid-cols-3 gap-6">
            <div class="form-group">
              <label for="inputEmail4" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Email</label
              >
            ...
            <div class="form-group">
              <label for="inputAddress" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Address</label
              >
              <input
                type="text"
            ...
            <div class="form-group">
              <label for="inputAddress2" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Address 2</label
              >
              <input
                type="text"
            ...
            <div class="form-group col-span-3">
              <div class="form-check">
                <input
                  ...
                  required
                />
                <label class="ms-1.5" for="checked-demo"> I agree to the Terms of Use </label>
              </div>
            </div>
