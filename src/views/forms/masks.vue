<template>
  <Layout>
    <Breadcrumb title="Masks" subtitle="Form" />
        ...
        <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
          <div>
            <form action="#">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-input" v-mask="'##:##:##'" placeholder="HH:MM:SS" />
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-input" v-mask="'#.##0,00'" placeholder="#.##0,00" />
              </div>
            </form>
          </div>
          ...
          <div>
            <form action="#">
              ...
              <div class="mb-3">
                <label class="text-gray-800 text-sm font-medium inline-block mb-2"
                  >Telephone with Code Area</label
                >
                <input
                  type="text"
                  class="form-input"
