<template>
  <Layout>
    <Breadcrumb title="Elements" subtitle="Forms" />

    <div class="flex flex-col gap-6">
      <CustomSyntax title="Input">
        <template #card-body>
          <p class="text-gray-400 mb-4">
            Most common form control, text-based input fields. Includes support for all HTML5 types:
            <code class="text-primary">text</code>, <code class="text-primary">password</code>,
            <code class="text-primary">datetime</code>,
            <code class="text-primary">datetime-local</code>,
            <code class="text-primary">date</code>, <code class="text-primary">month</code>,
            <code class="text-primary">time</code>, <code class="text-primary">week</code>,
            <code class="text-primary">number</code>, <code class="text-primary">email</code>,
            <code class="text-primary">url</code>, <code class="text-primary">search</code>,
            <code class="text-primary">tel</code>, and <code class="text-primary">color</code>.
          </p>
          ...
          <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div>
              <label for="example-email" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Email</label
              >
              <input
                type="email"
            ...
            <div>
              <label for="example-date" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Date</label
              >
            ...
            <div>
              <label for="example-month" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Month</label
              >
            ...
            <div>
              <label for="example-time" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Time</label
              >
            ...
            <div>
              <label for="example-week" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Week</label
              >
            ...
            <div>
              <label for="example-color" class="text-gray-800 text-sm font-medium inline-block mb-2"
                >Color</label
              >
              <input
      ...
      <div class="grid lg:grid-cols-2 gap-6">
        ...
        <CustomSyntax title="Radio Button">
          <template #card-body>
            <div class="grid md:grid-cols-2 gap-6">
              <div>
                <h6 class="text-sm mb-2">Default</h6>
              ...
              <div class="flex flex-col gap-3">
                ...
                <div class="flex items-center opacity-60">
                  <input
                    ...
                    disabled
                  />
                  <label class="ms-1.5" for="flexSwitchCheckCheckedDisabled"
