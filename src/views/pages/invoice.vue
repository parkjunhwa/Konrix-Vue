<template>
  <Layout>
    <Breadcrumb title="Invoice" subtitle="Extra Pages" />
    <div class="card p-6">
      <div class="flex justify-between">
        <div>
          <img class="h-6" src="/src/assets/images/logo-dark.png" alt="" />

          <h1 class="mt-2 text-lg md:text-xl font-semibold text-primary dark:text-white">
            Coderthemes Inc.
          </h1>
        </div>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2 items-center print:hidden">
          <a href="javascript:window.print()" class="btn bg-primary text-white"
            ><i class="mgc_print_line text-lg me-1"></i> Print</a
          >
          <a class="btn bg-info text-white">Submit</a>
        </div>
      </div>
    </div>
  </Layout>
