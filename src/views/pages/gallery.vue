<template>
  <Layout>
    <Breadcrumb title="Gallery" subtitle="Extra Pages" />
    <div class="flex flex-col gap-6">
      <div class="card">
        <div class="card-header">
          <h5 class="card-title uppercase">
            Filter Sort
            <a href="https://vestride.github.io/Shuffle/" target="_blank" class="text-primary"
              >(ShuffleJs)</a
            >
          </h5>
        </div>
        <div class="p-6">
          ...
          <div id="gallery-wrapper" class="flex justify-center h-auto">
            <div
              class="xl:w-1/4 lg:w-1/3 p-3 picture-item"
              data-groups='["creative", "photography"]'
            >
              <a class="image-popup" href="/src/assets/images/small/small-1.jpg">
                <div
            ...
            <div class="xl:w-1/4 lg:w-1/3 p-3 picture-item" data-groups='["design", "digital"]'>
              <a class="image-popup" href="/src/assets/images/small/small-2.jpg">
                <div
                  class="relative block overflow-hidden rounded group transition-all duration-500"
                >
                  <img
            ...
            <div
              ...
              data-groups='["creative", "photography"]'
            >
              <a class="image-popup" href="/src/assets/images/small/small-3.jpg">
                <div
                  class="relative block overflow-hidden rounded group transition-all duration-500"
                >
                  <img
            ...
            <div class="xl:w-1/4 lg:w-1/3 p-3 picture-item" data-groups='["design", "photography"]'>
              <a class="image-popup" href="/src/assets/images/small/small-4.jpg">
                <div
                  class="relative block overflow-hidden rounded group transition-all duration-500"
                >
                  <img
            ...
            <div class="xl:w-1/4 lg:w-1/3 p-3 picture-item" data-groups='["photography", "design"]'>
              <a class="image-popup" href="/src/assets/images/small/small-5.jpg">
                <div
                  class="relative block overflow-hidden rounded group transition-all duration-500"
                >
                  <img
            ...
            <div class="xl:w-1/4 lg:w-1/3 p-3 picture-item" data-groups='["digital", "creative"]'>
              <a class="image-popup" href="/src/assets/images/small/small-6.jpg">
                <div
                  class="relative block overflow-hidden rounded group transition-all duration-500"
                >
                  <img
            ...
            <div class="xl:w-1/4 lg:w-1/3 p-3 picture-item" data-groups='["creative", "digital"]'>
              <a class="image-popup" href="/src/assets/images/small/small-7.jpg">
                <div
                  class="relative block overflow-hidden rounded group transition-all duration-500"
                >
                  <img
            ...
            <div class="xl:w-1/4 lg:w-1/3 p-3 picture-item" data-groups='["design", "digital"]'>
              <a class="image-popup" href="/src/assets/images/small/small-8.jpg">
                <div
                  class="relative block overflow-hidden rounded group transition-all duration-500"
                >
                  <img
                    src="@/assets/images/small/small-8.jpg"
                    class="rounded transition-all duration-500 group-hover:scale-105"
                    alt="work-image"
                  />
                  <div
        ...
        <div class="p-6">
          ...
          <div class="grid xl:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
            <img
              ...
              src="@/assets/images/small/plant3.jpeg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded"
              src="@/assets/images/small/girl.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded"
              src="@/assets/images/small/plant2.jpeg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded"
              src="@/assets/images/small/statue1.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded"
              src="@/assets/images/small/vase.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded"
              src="@/assets/images/small/flower.jpeg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded"
              src="@/assets/images/small/flower2.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded"
            ...
            <img
              alt="gallery"
              class="object-cover object-center rounded"
              src="@/assets/images/small/plant.jpg"
            />
          </div>
        </div>
      </div>
        ...
        <div class="p-6">
          ...
          <div class="grid lg:grid-cols-4 md:grid-cols-3 gap-5">
            <div>
              <img
                alt="gallery"
                class="block object-cover object-center w-full h-full rounded"
                src="@/assets/images/small/statue1.jpg"
              />
            </div>
            <div>
              <img
                alt="gallery"
                class="block object-cover object-center w-full h-full rounded"
                src="@/assets/images/small/statue2.jpg"
              />
            </div>
        ...
        <div class="p-6">
          ...
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">
            <div class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative lg:col-span-2">
              <img
                alt="gallery"
                class="w-full object-cover h-full object-center block opacity-25 absolute inset-0 rounded"
                src="@/assets/images/small/plant.jpg"
              />
        ...
        <div class="p-6">
          ...
          <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5">
            <div class="flex relative">
              <img
                alt="gallery"
                class="absolute w-full h-full object-cover object-center rounded"
                src="@/assets/images/small/plant.jpg"
              />
      ...
      <div class="card">
        ...
        <div class="p-6">
          ...
          <div class="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-1 gap-5">
            <img
              alt="gallery"
              class="object-cover object-center rounded filter blur-sm"
              src="@/assets/images/small/plant3.jpeg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter brightness-50"
              src="@/assets/images/small/plant.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter contrast-50"
              src="@/assets/images/small/plant2.jpeg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter drop-shadow-2xl"
              src="@/assets/images/small/statue1.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter grayscale"
              src="@/assets/images/small/vase.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter hue-rotate-60"
              src="@/assets/images/small/boys.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter invert"
              src="@/assets/images/small/plant3.jpeg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter saturate-50"
              src="@/assets/images/small/vase.jpg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter sepia"
              src="@/assets/images/small/plant2.jpeg"
            />
            <img
              alt="gallery"
              class="object-cover object-center rounded filter hue-rotate-180"
              src="@/assets/images/small/plant.jpg"
            />
          </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    if (element) {
      shuffle = new Shuffle(element, { itemSelector: '.picture-item' })
    ...
    function addFilterButtons() {
      ...
      const onClick = _handleFilterClick.bind(this)
