<template>
  <Layout>
    <Breadcrumb title="Pricing" subtitle="Extra Pages" />
      ...
      >
        <div class="grid gap-px sm:grid-cols-2 lg:grid-cols-4 lg:items-center">
          <div class="flex flex-col h-full text-center">
            ...
            <div class="bg-white flex justify-center lg:mt-px pt-7 px-8 dark:bg-gray-800">
              <ul class="space-y-2.5 text-center text-sm">
                <li class="text-gray-800 dark:text-gray-400">1 user</li>

                <li class="text-gray-800 dark:text-gray-400">Plan features</li>

                <li class="text-gray-800 dark:text-gray-400">Product support</li>
              </ul>
            </div>

            <div class="bg-white py-8 px-8 dark:bg-gray-800">
              <a
                class="btn btn-lg border-primary text-primary hover:bg-primary hover:text-white"
                href="#"
              >
                Sign up
              </a>
          ...
          <div class="flex flex-col h-full text-center">
            ...
            <div class="bg-white flex justify-center lg:mt-px pt-7 px-8 dark:bg-gray-800">
              <ul class="space-y-2.5 text-center text-sm">
                <li class="text-gray-800 dark:text-gray-400">2 users</li>
          ...
          <div class="flex flex-col h-full text-center">
            ...
            <div class="bg-white flex justify-center lg:mt-px pt-7 px-8 dark:bg-gray-800">
              <ul class="space-y-2.5 text-center text-sm">
                <li class="text-gray-800 dark:text-gray-400">5 users</li>
          ...
          <div class="flex flex-col h-full text-center">
            ...
            <div class="bg-white flex justify-center lg:mt-px pt-7 px-8 dark:bg-gray-800">
              <ul class="space-y-2.5 text-center text-sm">
                <li class="text-gray-800 dark:text-gray-400">10 users</li>
            ...
            <div class="bg-white py-8 px-8 dark:bg-gray-800">
              <a class="btn btn-lg border-primary text-primary hover:bg-primary hover:text-white">
                Sign up
              </a>
            </div>
          </div>
