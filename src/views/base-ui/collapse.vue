<template>
  <Layout>
    <Breadcrumb title="Collapse" subtitle="Components" />
    <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
      <CustomSyntax title="Collapse with Targe">
        <template #card-body>
          <button
            type="button"
            class="hs-collapse-toggle btn bg-primary text-white"
            data-hs-collapse="#hs-basic-collapse-heading"
          >
            Collapse
            <i class="mgc_down_line hs-collapse-open:rotate-180 ms-2 transition-all text-xl"></i>
          </button>
          ...
          >
            <p class="pt-5 text-gray-800 dark:text-gray-200">
              ...
              reliable, requiring zero runtime. Whether you need to create form layouts, tables, or
              modal dialogs, Tailwind CSS provides everything necessary to design beautiful,
              responsive web applications. Additionally, the framework includes checkout forms,
              shopping carts, and product views, making it the ideal choice for developing your next
      ...
      <CustomSyntax title="Read More Collapse">
        <template #card-body>
          <a
            class="hs-collapse-toggle flex items-center text-primary"
            href="javascript:;"
