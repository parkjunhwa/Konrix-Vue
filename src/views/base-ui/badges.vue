<template>
  <Layout>
    <Breadcrumb title="Badge" subtitle="Components" />
    <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
      <CustomSyntax title="Default Badge">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-2">
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-black text-white"
              >Badge</span
            >
            <span
            ...
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-primary text-white"
              >Badge</span
            >
            <span
            ...
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-purple-500 text-white"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-pink-500 text-white"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-white text-gray-600"
              >Badge</span
            >
          </div>
        </template>
      ...
      <CustomSyntax title="Soft color variants Badge">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-2">
            <span
            ...
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-white/[.1] text-gray-600 dark:text-gray-400"
              >Badge</span
            >
          </div>
        </template>
      ...
      <CustomSyntax title="Rounded Badge">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-2">
            <span
            ...
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-red-100 text-red-800"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-yellow-100 text-yellow-800"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-green-100 text-green-800"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-primary/25 text-sky-800"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-indigo-100 text-indigo-800"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-purple-100 text-purple-800"
              >Badge</span
            >
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-white/[.1] text-gray-600 dark:text-gray-400"
              >Badge</span
            >
          </div>
        </template>
      ...
      <CustomSyntax title="Badge with Indicator">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-2">
            <span
              class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-gray-100 text-gray-800"
            ...
            >
              <span
                class="w-1.5 h-1.5 inline-block bg-gray-600 dark:text-gray-400 rounded-full"
              ></span>
              Badge
            </span>
          </div>
      ...
      <CustomSyntax title="Badge with Indicator">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-2">
            <span
              class="inline-flex items-center gap-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-gray-100 text-gray-800"
            >
              Badge
              <button
                type="button"
                class="flex-shrink-0 h-4 w-4 inline-flex items-center justify-center rounded-full text-gray-600 hover:bg-gray-200 hover:text-gray-500 focus:outline-none focus:bg-gray-200 focus:text-gray-500"
              >
            ...
            <span
              class="inline-flex items-center gap-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-white text-gray-500"
            >
              Badge
              <button
                type="button"
                class="flex-shrink-0 h-4 w-4 inline-flex items-center justify-center rounded-full text-gray-600 hover:bg-light hover:text-gray-500 focus:outline-none focus:bg-white focus:text-gray-500"
              >
                <span class="sr-only">Remove badge</span>
                <svg
                  class="h-4 w-4"
      ...
      <CustomSyntax title="Max width Badge">
        <template #card-body>
          <div class="flex flex-wrap items-end lg:gap-5 gap-">
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-gray-100 text-gray-800"
              >This content is a little bit longer.
            </span>
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-red-100 text-red-800"
              >This content is a little bit longer.
            </span>
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-yellow-100 text-yellow-800"
              >This content is a little bit longer.
            </span>
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-green-100 text-green-800"
              >This content is a little bit longer.
            </span>
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-primary/25 text-sky-800"
              >This content is a little bit longer.
            </span>
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-indigo-100 text-indigo-800"
              >This content is a little bit longer.
            </span>
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-purple-100 text-purple-800"
              >This content is a little bit longer.
            </span>
            <span
              class="max-w-[10rem] truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-md text-xs font-medium bg-white-100 text-gray-800"
              >This content is a little bit longer.
            </span>
          </div>
        </template>
      ...
      <CustomSyntax title="With button">
        <template #card-body>
          <div class="flex flex-wrap items-end lg:gap-5 gap-">
            <a
              class="relative py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
              href="#"
            >
              Notifications
              <span
                class="inline-flex items-center py-0.5 px-1.5 rounded-full text-xs font-medium bg-indigo-800 text-white"
                >5</span
              >
            </a>
          </div>
        ...
        <template #card-body>
          <div class="flex flex-wrap gap-x-7 gap-y-3">
            ...
            >
              ...
              <span
                class="absolute top-0 end-0 inline-flex items-center py-0.5 px-1.5 rounded-full text-xs font-medium transform -translate-y-1/2 translate-x-1/2 bg-rose-500 text-white"
                >99+</span
              >
            </a>
            ...
            >
              <i class="mgc_notification_line text-2xl"></i>
              <span
                class="absolute top-0 end-0 inline-flex items-center w-3.5 h-3.5 rounded-full border-2 border-white text-xs font-medium transform -translate-y-1/2 translate-x-1/2 bg-green-500 text-white"
              ></span>
            </a>
          </div>
        </template>
