<template>
  <Layout>
    <Breadcrumb title="Breadcrumb" subtitle="Components" />
    <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
      <CustomSyntax title="Simple">
        <template #card-body>
            ...
            <ol role="list" class="flex items-center text-sm font-semibold space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ms-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                    >Apps</a
                  >
                </div>
              </li>
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a
                    href="#"
                    class="ms-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                    aria-current="page"
                    >Calendar</a
                  >
                </div>
