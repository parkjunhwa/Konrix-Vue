<template>
  <Layout>
    <Breadcrumb title="Avatars" subtitle="Components" />
    <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
        ...
        <template #card-body>
          <div class="flex flex-wrap items-end gap-3">
            ...
            <div class="h-24 w-24 relative inline-flex">
              ...
              <div
                class="absolute end-0 m-2 h-3 w-3 border rounded-full border-white bg-success"
              ></div>
            </div>
      ...
      <CustomSyntax title="Rounded Circle Background Top Status">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-3">
      ...
      <CustomSyntax title="Circular avatars with bottom status">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-3">
            <div class="relative inline-block">
              ...
              />
              <span
                class="absolute bottom-0 end-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-gray-400"
              ></span>
            </div>
            <div class="relative inline-block">
              <img
                class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800"
                src="@/assets/images/users/avatar-2.jpg"
                alt="Image Description"
              />
              <span
                class="absolute bottom-0 end-0 block h-2.5 w-2.5 rounded-full ring-2 ring-white bg-red-400"
              ></span>
            </div>
            <div class="relative inline-block">
              <img
                class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800"
                src="@/assets/images/users/avatar-3.jpg"
                alt="Image Description"
              />
              <span
                class="absolute bottom-0 end-0 block h-3 w-3 rounded-full ring-2 ring-white bg-green-400"
              ></span>
            </div>
            <div class="relative inline-block">
              <img
              ...
              />
              <span
                class="absolute bottom-0 end-0 block h-3.5 w-3.5 rounded-full ring-2 ring-white bg-orange-400"
              ></span>
            </div>
          </div>
        </template>
      ...
      <CustomSyntax title="Rounded avatars with bottom status">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-3">
            <div class="relative inline-block">
              <img
                class="inline-block h-8 w-8 rounded-md ring-2 ring-white dark:ring-gray-800"
                src="@/assets/images/users/avatar-1.jpg"
                alt="Image Description"
              />
              <span
                class="absolute bottom-0 end-0 block h-1.5 w-1.5 rounded-full transform translate-y-1/2 translate-x-1/2 ring-2 ring-white bg-gray-400"
              ></span>
            </div>
            <div class="relative inline-block">
              <img
                class="inline-block h-9 w-9 rounded-md ring-2 ring-white dark:ring-gray-800"
                src="@/assets/images/users/avatar-2.jpg"
                alt="Image Description"
              />
              <span
                class="absolute bottom-0 end-0 block h-2.5 w-2.5 rounded-full transform translate-y-1/2 translate-x-1/2 ring-2 ring-white bg-red-400"
              ></span>
            </div>
            <div class="relative inline-block">
              <img
                class="inline-block h-12 w-12 rounded-md ring-2 ring-white dark:ring-gray-800"
                src="@/assets/images/users/avatar-3.jpg"
                alt="Image Description"
              />
              <span
                class="absolute bottom-0 end-0 block h-3 w-3 rounded-full transform translate-y-1/2 translate-x-1/2 ring-2 ring-white bg-green-400"
              ></span>
            </div>
            <div class="relative inline-block">
              <img
                class="inline-block h-16 w-16 rounded-md ring-2 ring-white dark:ring-gray-800"
                src="@/assets/images/users/avatar-4.jpg"
                alt="Image Description"
              />
              <span
                class="absolute bottom-0 end-0 block h-3.5 w-3.5 rounded-full transform translate-y-1/2 translate-x-1/2 ring-2 ring-white bg-orange-400"
              ></span>
            </div>
          </div>
        </template>
      ...
      <CustomSyntax title="Media">
        <template #card-body>
          <div class="flex flex-wrap items-end gap-3">
            <div class="flex-shrink-0 group block">
              <div class="flex items-center">
                <img
                  class="inline-block flex-shrink-0 h-16 w-16 rounded-full"
                  src="@/assets/images/users/avatar-5.jpg"
                  alt="Image Description"
                />
                <div class="ms-3">
      ...
      <CustomSyntax title="Image - Background Color">
        <template #card-body>
          <div class="flex gap-3">
            <div class="flex -space-x-2">
              <img
                class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-800"
                src="@/assets/images/users/avatar-1.jpg"
                alt="Image Description"
              />
              <div
      ...
      <CustomSyntax title="Border color">
        <template #card-body>
          <div class="flex flex-col gap-3">
            <div class="flex gap-2">
              <img
                class="inline-block h-8 w-8 rounded-full border-2 border-primary"
                src="@/assets/images/users/avatar-1.jpg"
                alt="Image Description"
              />
              <img
            ...
            <div class="flex gap-2">
              <img
                class="inline-block h-9 w-9 rounded-full border-2 border-red-300"
                src="@/assets/images/users/avatar-1.jpg"
                alt="Image Description"
              />
              <img
            ...
            <div class="flex gap-2">
              <img
                class="inline-block h-12 w-12 rounded-full border-2 border-teal-500"
                src="@/assets/images/users/avatar-1.jpg"
                alt="Image Description"
              />
              <img
            ...
            <div class="flex gap-2">
              <img
                class="inline-block h-16 w-16 rounded-full border-2 border-purple-400"
                src="@/assets/images/users/avatar-1.jpg"
                alt="Image Description"
              />
              <img
