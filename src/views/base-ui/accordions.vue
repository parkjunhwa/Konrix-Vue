<template>
  <Layout>
    <Breadcrumb title="Accordion" subtitle="Components" />
    <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
      <CustomSyntax title="Default Accordion">
        <template #card-body>
          <div class="hs-accordion-group">
            <div class="hs-accordion active" id="hs-basic-heading-one">
              ...
              >
                Accordion #1
                <i
                  class="mgc_add_line hs-accordion-active:hidden hs-accordion-active:text-blue-600 hs-accordion-active:group-hover:text-blue-600 block w-3 h-3 text-gray-600 group-hover:text-gray-500 dark:text-gray-400"
                ></i>
                <i
                  class="mgc_minimize_line hs-accordion-active:block hs-accordion-active:text-blue-600 hs-accordion-active:group-hover:text-blue-600 hidden w-3 h-3 text-gray-600 group-hover:text-gray-500 dark:text-gray-400"
                ></i>
              </button>
              <div
              ...
              >
                <p class="text-gray-800 dark:text-gray-200">
                  ...
                  form layouts, tables, or modal dialogs, Tailwind CSS provides everything necessary
                  to design beautiful, responsive web applications. Additionally, the framework
                  includes checkout forms, shopping carts, and product views, making it the ideal
                  choice for developing your next e-commerce front-end.
                </p>
              </div>
            </div>
      ...
      <CustomSyntax title="Always Open">
        <template #card-body>
          <div class="hs-accordion-group" data-hs-accordion-always-open>
            <div class="hs-accordion active" id="hs-basic-always-open-heading-one">
              <button
                class="hs-accordion-toggle hs-accordion-active:text-blue-600 py-3 inline-flex items-center gap-x-3 w-full font-semibold text-left text-gray-800 transition hover:text-gray-500 dark:hs-accordion-active:text-blue-500 dark:text-gray-200 dark:hover:text-gray-400"
          ...
          <div class="hs-accordion-group">
            ...
            >
              ...
              >
                ...
                Accordion #1
                <i
                  class="mgc_down_line hs-accordion-active:rotate-180 ms-auto transition-all text-xl"
                ></i>
              </button>
              <div
                  ...
                  <div class="hs-accordion active" id="hs-basic-nested-sub-heading-one">
                    ...
                    >
                      <p class="text-gray-800 dark:text-gray-200">
                        ...
                        to leave your HTML. The framework functions by scanning all of your HTML
                        files, JavaScript components, and templates for class names, automatically
                        generating corresponding styles, and writing them to a static CSS file. This
                        approach is fast, flexible, and reliable, requiring zero runtime. Whether
                        you need to create form layouts, tables, or modal dialogs, Tailwind CSS
                        provides everything necessary to design beautiful, responsive web
                        applications. Additionally, the framework includes checkout forms, shopping
                        carts, and product views, making it the ideal choice for developing your
...
import Prism from '@/components/custom-syntax.vue'
import CustomSyntax from '@/components/custom-syntax.vue'

export default {
  components: { CustomSyntax, Layout, Breadcrumb, Prism },
  data() {
    return {}
  },
}
