        ...
        <div class="card overflow-hidden sm:rounded-md rounded-none">
          <div class="p-6">
            ...
            <form @submit.prevent="register">
              ...
              <div class="mb-4">
                <div class="flex items-center">
                  ...
                  <label class="ms-2 text-slate-900 dark:text-slate-200" for="checkbox-signup"
                    >I accept <a class="text-gray-400 underline">Terms and Conditions</a></label
                  >
                </div>
              </div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-center">
              ...
              <router-link to="/login" class="text-primary ms-1"><b>Log In</b></router-link>
            </p>
          </div>
        </div>
      </div>
